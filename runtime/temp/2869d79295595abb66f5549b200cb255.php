    ...
    <div class="col-md-7 col-sm-12 col-xs-12 agreementlf f_l">
        <form id="project_form" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="setlist">
                ...
                <select  name="selectVal" v-model="selectVal"  class="btn_select f_l" @change="isstartNow(selectVal)">
            ...
            <div class="setlist" v-show="startNow">
                ...
                <input name="starttime" type="datetime-local" class="pro_lf textbox">
            </div>
            <div class="blank0"></div>
            <!--结束时间-->
            <div class="setlist">
                <label class="setmid" style="margin-right:25px;">结束时间</label>
                <input name="endtime" type="datetime-local" class="pro_lf textbox">
            </div>
            <div class="blank0"></div>
            <!--支持金额-->
            <div class="setlist">
          ...
          <!--限额-->
            <div class="setlist">
                ...
                <input name="totalpart"  v-model="totalpart"  @keyup="limitInt()" class="pro_lf textbox">
