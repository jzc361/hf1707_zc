<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\AppServ\www\hf170724_zc\hf1707_zc\public/../application/admin\view\login\index.html";i:1517448844;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe id="showframe" src="<?php echo url('admin/controll/person'); ?>" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>

              <!--<?php echo url('admin/login/toMain'); ?>-->
          </div>
        </div>
    </div>
