/**
 * Created by LinTong on 2018/2/3.
 */
...
;(function($, window, document) {
    ...
    Slide.prototype = {
        ...
        loadDom : function() {
            ...
            panelHtml += '<div class="verify-bar-area"><span  class="verify-msg">滑块验证</span><div class="verify-left-bar"><span  class="verify-msg"></span><div  class="verify-move-block"><i  class="verify-icon iconfont icon-right"></i>'+tmpHtml+'</div></div></div>';
            ...
            //普通滑动
                ...
                if(parseInt(this.htmlDoms.move_block.css('left')) >= (parseInt(this.setSize.bar_width) - parseInt(this.options.barSize.height) - parseInt(this.options.vOffset))) {
                    ...
                    setTimeout(function () {
                        ...
                        _this.$element.find('.verify-msg:eq(0)').text('滑块验证');
